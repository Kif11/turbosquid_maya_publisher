...
class SnapShotClass:
    ...
    def SetSqrCamera():
        ...
        if os.path.exists(os.path.expanduser('~/maya/Turbosquid/CheckMate Tools For Maya/CM_Tools/') + "Imaging/GetObjPixelDimension.exe"):    
            program = os.path.expanduser('~/maya/Turbosquid/CheckMate Tools For Maya/CM_Tools/') + "Imaging/GetObjPixelDimension.exe"  
        elif os.path.exists(os.path.expanduser('~/maya/Turbosquid/CheckMate Tools For Maya/CM_Tools/') + "Imaging/GetObjPixelDimension"):
            program = os.path.expanduser('~/maya/Turbosquid/CheckMate Tools For Maya/CM_Tools/') + "Imaging/GetObjPixelDimension"  
    ...
    def CreateImagePlanes():
        ...
        for i in range(0,len(subLayers)):
            ...
            cmds.setAttr(shapeForeground + ".imageName", os.path.expanduser('~/maya/Turbosquid/CheckMate Tools For Maya/CM_Tools/') + "Imaging/Txt_-_Subdivision_Lv_" + str(i) + "-b.png", type = "string")
        ...
        for layer in wireLayers:
            ...
            cmds.setAttr(shapeBackground + ".imageName", os.path.expanduser('~/maya/Turbosquid/CheckMate Tools For Maya/CM_Tools/') + "WireColor" + ".jpg", type = "string")
        ...
        for layer in sigLayers:
            ...
            cmds.editRenderLayerAdjustment( shapeBackground + ".imageName" )
            cmds.setAttr(shapeBackground + ".imageName", os.path.expanduser('~/maya/Turbosquid/CheckMate Tools For Maya/CM_Tools/') + "SignatureColor.jpg", type = "string")
    ...
    def UpdatePaths():
        ...
        for i in range(0,len(subLayers)):
            cmds.editRenderLayerGlobals( currentRenderLayer = subLayers[i])
            #Adjustments for the foreground plane
            cmds.setAttr(Camera + "|CMForegroundPlane" + ".imageName", os.path.expanduser('~/maya/Turbosquid/CheckMate Tools For Maya/CM_Tools/') + "Imaging/Txt_-_Subdivision_Lv_" + str(i) + "-b.png", type = "string")
        ...
        for layer in wireLayers:
            ...
            for i in cameraObjects:
                cmds.setAttr(i + ".imageName", os.path.expanduser('~/maya/Turbosquid/CheckMate Tools For Maya/CM_Tools/') + "WireColor" + ".jpg", type = "string")
        ...
        for layer in sigLayers:
            cmds.editRenderLayerGlobals( currentRenderLayer = layer)    
            for i in cameraObjects:
                cmds.setAttr(i + ".imageName", os.path.expanduser('~/maya/Turbosquid/CheckMate Tools For Maya/CM_Tools/') + "SignatureColor" + ".jpg", type = "string")
        print "Paths updated"
